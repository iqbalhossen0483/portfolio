    ...
    return (
        <div id='service' className='text-xl pt-16'>
            <div className='w-2/4 mx-auto my-10 text-center'>
                ...
                <p className='text-5xl font-bold pb-5'>My Awesome Services</p>
                <p>Since my knowledge based on JavaScript, I can serve you all about this. You know, Javascript a programming language which is able to handle all kind of things like web app, android app and soo on.</p>
            </div>
